<#
 .Synopsis
 Export Citrix Site configuration to XML file

 .Description
 Export Citrix Site to XML file in the current directory named as export.xml.
 Exported element are:
...
Icons encoded data are exported to a "resources" folder in the current directory.

 .Parameter DeliveryController
 Specifiy the Delivery Controller to use for configuration's export.
 ...
 .Example
 # Connect to "CTXDDC01" to export the configuration
 Export-CitrixSite.ps1 -DeliveryController "CTXDDC01" 

.Example
 # Export the configuration and log the output in C:\Temp\test.log
 Export-CitrixSite.ps1 Log "C:\temp\test.log"
#>
